...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=DEV21\\SQLEXPRESS; Initial Catalog=Inlock_Games_Manha; user Id=sa;pwd=sa@132;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Jogos>(entity =>
            {
                ...
                entity.Property(e => e.IdJogos).HasColumnName("Id_Jogos");
                ...
                entity.HasOne(d => d.IdEstudioNavigation)
                    ...
                    .HasConstraintName("FK__Jogos__Id_Estudi__5535A963");
            });
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                ...
                entity.HasOne(d => d.IdTipoUsuarioNavigation)
                    ...
                    .HasConstraintName("FK__Usuario__Id_Tipo__5070F446");
            });
        }
    }
}
